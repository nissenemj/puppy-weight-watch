                ...
                <header className="mb-10">
                    ...
                    {dogs.length > 0 ? (
                        <p className="text-stone-600 mt-2 text-lg">
                            Tässä on pennun {dogs[0].name} tilannekatsaus.
                        </p>
                    ) : (
                        <p className="text-stone-600 mt-2 text-lg">
                            Aloita lisäämällä pentusi tiedot.
                        </p>
                    )}
                </header>
                        ...
                        <Card className="border-0 shadow-md bg-white/60 backdrop-blur-sm hover:bg-white/80 transition-all group">
                            ...
                            <CardContent>
                                {lastWeight ? (
                                    ...
                                    <div className="py-2">
                                        <p className="text-stone-500 mb-2">Ei mittauksia vielä</p>
                                        <Button variant="outline" size="sm" asChild>
                                            <Link to="/weight-tracker">Lisää ensimmäinen</Link>
                                        </Button>
                                    </div>
                                )}
                            </CardContent>
                                ...
                                <CardFooter>
                                    <Button variant="ghost" className="w-full justify-between text-terracotta-600 hover:text-terracotta-700 p-0 hover:bg-transparent" asChild>
                                        <Link to="/weight-tracker">
                                            Lisää uusi mittaus <Plus className="w-4 h-4" />
                                        </Link>
                                    </Button>
                                </CardFooter>
                            )}
