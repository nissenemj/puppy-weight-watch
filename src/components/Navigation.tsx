...
const NavigationWithRouter = () => {
  ...
  return <>
      <header role="banner" aria-label="Sivun ylätunniste">
        ...
        <a href="#main-content" className="skip-link fixed left-[-9999px] top-4 z-[300] glass px-4 py-2 rounded-xl focus:left-4 transition-all duration-300 text-gray-800 font-medium">Siirry suoraan sisältöön</a>
